...
public class MainActivity extends AppCompatActivity {
    ...
    private static String urlApi = "http://localhost/ROLM_sae_s4_CYM_v2/API_CheckYourMood/login?login";
    ...
    public void seConnecter (View view) {
        try {
            ...
            String pwd = URLEncoder.encode(editTextLogin.getText().toString(), "UTF-8");
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject reponse) {
                            ...
                            if (reponse != null && reponse.length() > 0) {
                                int statusCode = 0;
                                try {
                                    statusCode = reponse.getInt("statusCode");
                                } catch (JSONException e) {
                                    throw new RuntimeException(e);
                                }
                                if (statusCode == 200) {
